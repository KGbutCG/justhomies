...
area = [["*", "*", "*"], ["*", "*", "*"], ["*", "*", "*"]]
print('привет, первый игрок, здесь крестики нолики')
...
for turn in range(1,10):
    ...
    row = int(input('input stroku (1,2,3)')) - 1
    column = int(input('input colonnu (1,2,3)')) - 1
    if area[row] [column] == '*':
        area [row][column] = turn_char
    else:
        print('you missed your chance, bruh')
        draw_area()
        continue
    draw_area()
